...
// -------------------------
        ...
        void band_matrix::resize(int dim, int n_u, int n_l) {
            ...
            assert(n_u >= 0);
            assert(n_l >= 0);
            m_upper.resize(static_cast<unsigned long>(n_u + 1));
            m_lower.resize(static_cast<unsigned long>(n_l + 1));
...
// -----------------------
        ...
        void spline::set_points(const std::vector<double> &x,
            ...
            if (cubic_spline) { // cubic spline interpolation
                ...
                m_a.resize(static_cast<unsigned long>(n));
                m_c.resize(static_cast<unsigned long>(n));
                for (int i = 0; i < n - 1; i++) {
                ...
                m_a.resize(static_cast<unsigned long>(n));
                m_b.resize(static_cast<unsigned long>(n));
                m_c.resize(static_cast<unsigned long>(n));
                for (int i = 0; i < n - 1; i++) {
                    m_a[i] = 0.0;
                    m_b[i] = 0.0;
