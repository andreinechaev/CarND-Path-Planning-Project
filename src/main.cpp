                ...
                if (length > 2 && data[0] == '4' && data[1] == '2') {
                    ...
                    if (!s.empty()) {
                        ...
                        if (event == "telemetry") {
                            ...
                            // references for the car position
                            double ref_x = car_x;
                            double ref_y = car_y;
                            double ref_yaw = deg2rad(car_yaw);

                            // if the previous path is almost empty, use car's starting point
                            if (prev_size < 2) {
                                ...
                                // redefine previous state reference
                            ...
                            // In Frenet add evenly spaced waypoint every 30m
